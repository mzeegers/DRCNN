...
# This script carries out the UNet and DRUNet network training on hyperspectral remote sensing based data (and on data compressed by PCA, NMF and LDA methods) without overlapping objects
...
#Settings
DataPath = '../../../../../data/RemoteSensingDatasets/PartiallyOverlappingFalse/'
DataReduction = False
DataReductionList = []
...
if(DataReduction):
    ...
    SettingsExt = '_' + DataSet + '_DR' + str(DataReduction)
