...
# This script carries out the UNet and DRUNet network training on hyperspectral remote sensing based data (and on data compressed by PCA, NMF and LDA methods) with overlapping objects
