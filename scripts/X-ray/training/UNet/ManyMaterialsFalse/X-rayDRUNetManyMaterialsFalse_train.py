...
# This script carries out the UNet and DRUNet network training on hyperspectral X-ray data (and on data compressed by PCA, NMF and LDA methods) with few different materials
