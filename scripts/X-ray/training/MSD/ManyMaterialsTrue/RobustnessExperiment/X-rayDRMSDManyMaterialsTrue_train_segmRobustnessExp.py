...
# This script carries out the MSD and DRMSD network training on hyperspectral X-ray data (and on data compressed by PCA, NMF and LDA methods) with many different materials and different random seeds
...
if(DataReduction):
    ...
    SettingsExt = '_' + Dataset + '_layers' + str(layers) + 'dil' + str(dilations) + 'DR' + str(DataReduction) + '_seed' + str(seed)
