#NMF compression for hyperspectral X-ray projections

#This script applies NMF compression to the (training set of the) hyperspectral X-ray projections
...
NMF_Reduction(DatasetPath, Dataset, 60, LimLow, LimHigh, Sample)
Sample = 6
NMF_Reduction(DatasetPath, Dataset, 200, LimLow, LimHigh, Sample)
